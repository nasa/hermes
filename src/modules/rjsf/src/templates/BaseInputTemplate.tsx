...
import { VSCodeNumberField } from '../widgets/VSCodeNumberField/VSCodeNumberField';
...
>(props: BaseInputTemplateProps<T, S, F>) {
    ...
    const Component = inputProps.type === "number" ? VSCodeNumberField : VSCodeTextField;
    ...
    return (
        <>
            <Component
                ...
                disabled={disabled}
                autoFocus={autofocus}
                value={inputValue ?? (inputProps.type === "number" ? 0 : '')}
                {...inputProps as any}
                list={schema.examples ? examplesId<T>(id) : undefined}
                onChange={(onChangeOverride || _onChange) as any}
                onInput={(onChangeOverride || _onChange) as any}
                onBlur={_onBlur}
                onFocus={_onFocus}
